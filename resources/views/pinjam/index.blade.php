...
<head>
    <meta charset="UTF-8">
    <title>Image gallery with bootstrap 4</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 mb-3">
            ...
            <center><p>Contoh cover hard book</p></center>
        </div>
        <div class="col-md-8">
            <h3>{{ $item->judul }}</h3>
            <h4>by {{ $item->penulis }}</h4>
            <h5>Kategori: <a href="#">[category]</a></h5>
            ...
            <form action="{{ route('pinjam.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-primary mt-3"><i class="fas fa-book"></i> Pinjam Buku Ini</button>
            </form>
        </div>
    </div>
</div>
